...
module.exports = () => {
  ...
  .then(() => {
    log.success(`Release draft ready! Check out new entry in ${changelog.changelogFilename} and give it a final touch.`);
    log.success(`When you're done, don't commit the changes on your own. Run command "${finishCommand()}" and we'll do it for you.`);
  })
  .catch((err) => {
